...
// SSOConnectorProviders - Endpoints for SSO (single sign-on) connector providers.
//
...
func (s *SSOConnectorProviders) ListSsoConnectorProviders(ctx context.Context, opts ...operations.Option) (*operations.ListSsoConnectorProvidersResponse, error) {
