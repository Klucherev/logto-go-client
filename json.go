...
// JSON - Endpoints for the Swagger JSON document.
type JSON struct {
	sdkConfiguration sdkConfiguration
}

func newJSON(sdkConfig sdkConfiguration) *JSON {
	return &JSON{
...
func (s *JSON) GetSwaggerJSON(ctx context.Context, opts ...operations.Option) (*operations.GetSwaggerJSONResponse, error) {
