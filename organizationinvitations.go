...
// OrganizationInvitations - Organization invitations are used to invite users to join an organization. They are sent via email and contain a link that the user can click to accept the invitation and join the organization.
...
func (s *OrganizationInvitations) GetOrganizationInvitation(ctx context.Context, id string, opts ...operations.Option) (*operations.GetOrganizationInvitationResponse, error) {
...
func (s *OrganizationInvitations) DeleteOrganizationInvitation(ctx context.Context, id string, opts ...operations.Option) (*operations.DeleteOrganizationInvitationResponse, error) {
...
func (s *OrganizationInvitations) ListOrganizationInvitations(ctx context.Context, organizationID *string, inviterID *string, invitee *string, opts ...operations.Option) (*operations.ListOrganizationInvitationsResponse, error) {
...
func (s *OrganizationInvitations) CreateOrganizationInvitation(ctx context.Context, request operations.CreateOrganizationInvitationRequest, opts ...operations.Option) (*operations.CreateOrganizationInvitationResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
func (s *OrganizationInvitations) CreateOrganizationInvitationMessage(ctx context.Context, id string, requestBody operations.CreateOrganizationInvitationMessageRequestBody, opts ...operations.Option) (*operations.CreateOrganizationInvitationMessageResponse, error) {
...
func (s *OrganizationInvitations) ReplaceOrganizationInvitationStatus(ctx context.Context, id string, requestBody operations.ReplaceOrganizationInvitationStatusRequestBody, opts ...operations.Option) (*operations.ReplaceOrganizationInvitationStatusResponse, error) {
