...
* [ListUserCustomData](#listusercustomdata) - Get user custom data
* [UpdateUserCustomData](#updateusercustomdata) - Update user custom data
* [UpdateUserProfile](#updateuserprofile) - Update user profile
* [CreateUser](#createuser) - Create user
* [ListUsers](#listusers) - Get users
* [UpdateUserPassword](#updateuserpassword) - Update user password
* [VerifyUserPassword](#verifyuserpassword) - Verify user password
* [GetUserHasPassword](#getuserhaspassword) - Check if user has password
* [UpdateUserIsSuspended](#updateuserissuspended) - Update user suspension status
* [ListUserRoles](#listuserroles) - Get roles for user
* [AssignUserRoles](#assignuserroles) - Assign roles to user
* [ReplaceUserRoles](#replaceuserroles) - Update roles for user
* [DeleteUserRole](#deleteuserrole) - Remove role from user
* [ReplaceUserIdentity](#replaceuseridentity) - Update social identity of user
* [DeleteUserIdentity](#deleteuseridentity) - Delete social identity from user
* [CreateUserIdentity](#createuseridentity) - Link social identity to user
* [ListUserOrganizations](#listuserorganizations) - Get organizations for a user
* [ListUserMfaVerifications](#listusermfaverifications) - Get user's MFA verifications
* [CreateUserMfaVerification](#createusermfaverification) - Create an MFA verification for a user
* [DeleteUserMfaVerification](#deleteusermfaverification) - Delete an MFA verification for a user
* [ListUserPersonalAccessTokens](#listuserpersonalaccesstokens) - Get personal access tokens
* [CreateUserPersonalAccessToken](#createuserpersonalaccesstoken) - Add personal access token
* [DeleteUserPersonalAccessToken](#deleteuserpersonalaccesstoken) - Delete personal access token
* [UpdateUserPersonalAccessToken](#updateuserpersonalaccesstoken) - Update personal access token
...
func main() {
    ...
    res, err := s.Users.GetUser(ctx, "<id>", nil)
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    res, err := s.Users.UpdateUser(ctx, "<id>", operations.UpdateUserRequestBody{})
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    res, err := s.Users.DeleteUser(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
func main() {
    ...
    res, err := s.Users.ListUserCustomData(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    res, err := s.Users.UpdateUserCustomData(ctx, "<id>", operations.UpdateUserCustomDataRequestBody{
...
func main() {
    ...
    res, err := s.Users.UpdateUserProfile(ctx, "<id>", operations.UpdateUserProfileRequestBody{
...
func main() {
    ...
    res, err := s.Users.ListUsers(ctx, nil, nil, nil)
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Users.UpdateUserPassword(ctx, "<id>", operations.UpdateUserPasswordRequestBody{
        Password: "8FlcXwBmyo30CwA",
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Users.VerifyUserPassword(ctx, "<id>", operations.VerifyUserPasswordRequestBody{
        Password: "MYafW3jnE2F_FqM",
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Users.GetUserHasPassword(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    res, err := s.Users.UpdateUserIsSuspended(ctx, "<id>", operations.UpdateUserIsSuspendedRequestBody{
        IsSuspended: true,
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Users.ListUserRoles(ctx, "<id>", nil, nil, nil)
    if err != nil {
        log.Fatal(err)
    }
    if res.ResponseBodies != nil {
...
func main() {
    ...
    res, err := s.Users.AssignUserRoles(ctx, "<id>", operations.AssignUserRolesRequestBody{
        RoleIds: []string{},
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Users.ReplaceUserRoles(ctx, "<id>", operations.ReplaceUserRolesRequestBody{
        RoleIds: []string{
            "<value 1>",
            "<value 2>",
            "<value 3>",
...
func main() {
    ...
    res, err := s.Users.DeleteUserRole(ctx, "<id>", "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
func main() {
    ...
    res, err := s.Users.ReplaceUserIdentity(ctx, "<id>", "<value>", operations.ReplaceUserIdentityRequestBody{
        UserID: "<id>",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Users.DeleteUserIdentity(ctx, "<id>", "<value>")
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    res, err := s.Users.CreateUserIdentity(ctx, "<id>", operations.CreateUserIdentityRequestBody{
        ConnectorID: "<id>",
...
func main() {
    ...
    res, err := s.Users.ListUserOrganizations(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.ResponseBodies != nil {
...
func main() {
    ...
    res, err := s.Users.ListUserMfaVerifications(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.ResponseBodies != nil {
...
func main() {
    ...
    res, err := s.Users.CreateUserMfaVerification(ctx, "<id>", operations.CreateCreateUserMfaVerificationRequestBodyCreateUserMfaVerificationRequestBody1(
...
func main() {
    ...
    res, err := s.Users.DeleteUserMfaVerification(ctx, "<id>", "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
func main() {
    ...
    res, err := s.Users.ListUserPersonalAccessTokens(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.ResponseBodies != nil {
...
func main() {
    ...
    res, err := s.Users.CreateUserPersonalAccessToken(ctx, "<id>", operations.CreateUserPersonalAccessTokenRequestBody{
        Name: "<value>",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Users.DeleteUserPersonalAccessToken(ctx, "<id>", "<value>")
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
func main() {
    ...
    res, err := s.Users.UpdateUserPersonalAccessToken(ctx, "<id>", "<value>", operations.UpdateUserPersonalAccessTokenRequestBody{
        Name: "<value>",
    })
    if err != nil {
        log.Fatal(err)
