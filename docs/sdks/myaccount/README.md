...
* [UpdateOtherProfile](#updateotherprofile) - Update other profile
...
func main() {
    ...
    res, err := s.MyAccount.UpdateProfile(ctx, operations.UpdateProfileRequest{})
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    res, err := s.MyAccount.UpdateOtherProfile(ctx, operations.UpdateOtherProfileRequest{})
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
