...
* [ListOrganizationScopes](#listorganizationscopes) - Get organization scopes
* [CreateOrganizationScope](#createorganizationscope) - Create an organization scope
* [GetOrganizationScope](#getorganizationscope) - Get organization scope
* [UpdateOrganizationScope](#updateorganizationscope) - Update organization scope
* [DeleteOrganizationScope](#deleteorganizationscope) - Delete organization scope
...
func main() {
    ...
    res, err := s.OrganizationScopes.ListOrganizationScopes(ctx, nil, nil, nil)
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.OrganizationScopes.CreateOrganizationScope(ctx, operations.CreateOrganizationScopeRequest{
        Name: "<value>",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.OrganizationScopes.GetOrganizationScope(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    res, err := s.OrganizationScopes.UpdateOrganizationScope(ctx, "<id>", operations.UpdateOrganizationScopeRequestBody{})
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    res, err := s.OrganizationScopes.DeleteOrganizationScope(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
