...
// DeleteSentinelActivities - Bulk delete sentinel activities
...
func (s *SentinelActivities) DeleteSentinelActivities(ctx context.Context, request operations.DeleteSentinelActivitiesRequest, opts ...operations.Option) (*operations.DeleteSentinelActivitiesResponse, error) {
