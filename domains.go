...
func (s *Domains) ListDomains(ctx context.Context, opts ...operations.Option) (*operations.ListDomainsResponse, error) {
...
func (s *Domains) GetDomain(ctx context.Context, id string, opts ...operations.Option) (*operations.GetDomainResponse, error) {
...
// Delete domain by ID.
func (s *Domains) DeleteDomain(ctx context.Context, id string, opts ...operations.Option) (*operations.DeleteDomainResponse, error) {
